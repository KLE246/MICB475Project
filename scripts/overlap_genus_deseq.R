...
# Group by genus
combined_phyloseq <- tax_glom(combined_phyloseq, taxrank = "Genus")
...
bar_plot
ggsave(filename="plots/separated_similar_genus_bar_plot.png",bar_plot)


#Unused as results from first plot are good enough for analysis
